...
export function QuickSetup({
  ...
  return <div className="space-y-10">
      ...
      <div className="bg-[#111827]/50 p-6 rounded-lg border border-[#374151]">
        ...
        size: value
      })} helperText="How many people currently work at your organisation?" className="md:max-w-2xl" />
      </div>
      <div className="bg-[#111827]/50 p-6 rounded-lg border border-[#374151]">
        <h3 className="text-lg font-medium text-white mb-4 flex items-center">
      ...
      <div className="bg-[#111827]/50 p-6 rounded-lg border border-[#374151]">
        ...
        revenueStatus: value
      })} helperText="Where is your organisation in terms of revenue generation?" className="md:max-w-2xl" />
      </div>
      <div className="bg-[#111827]/50 p-6 rounded-lg border border-[#374151]">
        <h3 className="text-lg font-medium text-white mb-4 flex items-center">
        ...
        keyInvestors: value
      })} placeholder="Add investor and press Enter..." helperText="Add your key investors or leave blank if not applicable" maxTags={5} className="md:max-w-2xl" />
      </div>
    </div>;
}