...
export function QuickSetup({
  ...
  const organizationSizes = [{ value: '1-10', label: '1–10' }, { value: '11-50', label: '11–50' }, { value: '51-200', label: '51–200' }, { value: '201-1000', label: '201–1000' }, { value: '1000+', label: '1000+' }];
  const fundingStatuses = [
    { value: 'bootstrapped', label: 'Bootstrapped', description: 'Self-funded without external investment' },
    { value: 'pre-seed', label: 'Pre-Seed', description: 'Early funding to develop initial product' },
    { value: 'seed', label: 'Seed', description: 'Funding to validate business model' },
    { value: 'series-a', label: 'Series A', description: 'Funding to scale proven business model' },
    { value: 'series-b-plus', label: 'Series B+', description: 'Later stage funding rounds' },
  ...
  const companyFunctions = [
    ...
    { value: 'healthtech', label: 'Healthtech', description: 'Healthcare technology' },
  ...
  const revenueStatuses = [{ value: 'pre-revenue', label: 'Pre-Revenue' }, { value: 'early-revenue', label: 'Early Revenue' }, { value: 'growing-revenue', label: 'Growing Revenue' }, { value: 'scaled-revenue', label: 'Scaled Revenue' }];
  return <div className="space-y-10">
      ...
      <div className="bg-[#111827]/50 p-6 rounded-lg border border-[#374151] mb-6">
        ...
        <RadioGroup 
          ...
          className="w-full"
          optionsContainerClassName="gap-4"
