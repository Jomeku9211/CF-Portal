...
export function Header() {
  return <header className="w-full sticky top-0 z-50">
      {/* Top bar */}
      <div className="w-full bg-gradient-to-r from-sanjuan-base to-sanjuan-dark text-white py-2">
        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/about" className="text-sanjuan-dark hover:text-sanjuan-base font-medium text-base transition-colors duration-200">
                About
              </Link>
              <Link to="/podcast" className="text-sanjuan-dark hover:text-sanjuan-base font-medium text-base transition-colors duration-200">
                Podcast
              </Link>
              <Link to="/contact" className="text-sanjuan-dark hover:text-sanjuan-base font-medium text-base transition-colors duration-200">
                Contact Us
              </Link>
              <Link to="/login" className="bg-tango-lighter text-tango-dark hover:bg-tango-light hover:text-tango-darker px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                Login
              </Link>
            </nav>
            <button className="md:hidden text-sanjuan-dark hover:text-sanjuan-base transition-colors duration-200">
