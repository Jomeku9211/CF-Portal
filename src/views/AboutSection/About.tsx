...
const About = () => {
  ...
  return (
    <div data-testid="AboutId" className="w-full bg-white">
      {/* Headline Section */}
            ...
            <div className="w-full md:w-2/5">
              <div className="relative bg-blue-50 rounded-2xl p-6 shadow-lg">
                <img 
                  ...
                  alt="Founders building Coderfarm from experience" 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 mb-20 bg-gray-50 rounded-2xl p-8">
            ...
            <div className="w-full md:w-1/2">
              <div className="mb-4">
                <img 
                  src="https://img.freepik.com/free-vector/recruitment-concept-illustration_114360-6766.jpg" 
                  alt="Broken hiring system illustration" 
                  className="w-full h-auto rounded-xl" 
                />
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="w-full md:w-2/5">
              <div className="relative bg-blue-50 rounded-2xl p-6 shadow-lg">
                <img 
                  src="https://img.freepik.com/free-vector/network-concept-illustration_114360-4469.jpg" 
                  alt="Future of talent infrastructure" 
                  className="w-full h-auto rounded-xl" 
                />
              </div>
            </div>
