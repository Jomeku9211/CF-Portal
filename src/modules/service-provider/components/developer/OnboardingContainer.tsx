          ...
          <div className="px-6 sm:px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-between">
            {currentStep > 1 ? (
              <button
                type="button"
                onClick={prevStep}
                className="inline-flex items-center px-4 py-2 border border-sanjuan-lighter rounded-lg text-sanjuan-dark hover:bg-sanjuan-lightest transition-colors"
              >
            ...
            <button
              type="submit"
              className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-sanjuan-base to-sanjuan-dark text-white font-medium rounded-lg shadow-sm hover:shadow transition-all"
            >
