...
export function Button({
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent border border-[#4b5563] text-white hover:bg-[#4b5563]',
    auth: 'bg-green-500 hover:bg-green-600 text-white focus:ring-green-500'
  } as const;
  const sizeStyles = {
  ...
  return (
    <button className={`${baseStyles} ${variantStyles[variant]} ${sizeStyles[size]} ${widthClass} ${className}`} {...props}>
