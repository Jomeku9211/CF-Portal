...
export const Heading: React.FC<HeadingProps> = ({
  ...
  switch (level) {
    case 1:
      return <h1 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    case 2:
      return <h2 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    case 3:
      return <h3 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    case 4:
      return <h4 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    case 5:
      return <h5 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    case 6:
      return <h6 className={cn(levelStyles[level], className)} data-id={dataId} {...props} />;
    default:
      return <h1 className={cn(levelStyles[1], className)} data-id={dataId} {...props} />;
  }
};
