...
export function ForgotPassword() {
  ...
  const handleSubmitEmail = async (e: React.FormEvent) => {
    ...
    try {
          // Send forgot password request to Supabase
    const response = await fetch(`${process.env.REACT_APP_SUPABASE_URL || 'https://your-project.supabase.co'}/auth/v1/recover`, {
        method: 'POST',
        headers: {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_SUPABASE_URL || 'https://your-project.supabase.co'}/auth/v1/verify`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    const response = await fetch(`${process.env.REACT_APP_SUPABASE_URL || 'https://your-project.supabase.co'}/auth/v1/update`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
