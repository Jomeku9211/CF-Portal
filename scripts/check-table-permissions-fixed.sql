-- ============================================
-- Check current permissions on user_onboarding_progress table (FIXED)
-- ============================================
...
-- 7. Check sequence permissions (for auto-incrementing IDs) - FIXED
SELECT 
    grantee,
    privilege_type,
    is_grantable
FROM information_schema.role_usage_grants 
WHERE object_name LIKE '%user_onboarding_progress%';
