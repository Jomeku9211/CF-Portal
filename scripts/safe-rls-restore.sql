-- =====================================================
-- SAFE RLS POLICIES RESTORATION (DROPS EXISTING FIRST)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view teams in own organizations" ON public.teams;
DROP POLICY IF EXISTS "Users can create teams in own organizations" ON public.teams;
DROP POLICY IF EXISTS "Users can update teams in own organizations" ON public.teams;
DROP POLICY IF EXISTS "Users can delete teams in own organizations" ON public.teams;

-- Drop existing policies on job_posts table
DROP POLICY IF EXISTS "Users can view job posts in own organizations" ON public.job_posts;
DROP POLICY IF EXISTS "Users can create job posts in own organizations" ON public.job_posts;
DROP POLICY IF EXISTS "Users can update job posts in own organizations" ON public.job_posts;
DROP POLICY IF EXISTS "Users can delete job posts in own organizations" ON public.job_posts;

-- Drop existing policies on user_onboarding_progress table
...
-- Drop existing policies on onboarding_step_completions table
DROP POLICY IF EXISTS "Users can view own step completions" ON public.onboarding_step_completions;
DROP POLICY IF EXISTS "Users can create own step completions" ON public.onboarding_step_completions;
DROP POLICY IF EXISTS "Users can update own step completions" ON public.onboarding_step_completions;
DROP POLICY IF EXISTS "Users can delete own step completions" ON public.onboarding_step_completions;
...
-- =====================================================
-- STEP 6: CREATE RLS POLICIES FOR JOB POSTS
-- =====================================================
...
-- =====================================================
-- STEP 7: CREATE RLS POLICIES FOR USER ONBOARDING PROGRESS
-- =====================================================
...
-- =====================================================
-- STEP 8: CREATE RLS POLICIES FOR USER ROLES
-- =====================================================
...
-- =====================================================
-- STEP 9: CREATE RLS POLICIES FOR ONBOARDING STEP COMPLETIONS
-- =====================================================
